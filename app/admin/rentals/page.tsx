    ...
    <Dialog open={openEdit} onOpenChange={setOpenEdit}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add or modify rental equipment available for hikers.
          </DialogDescription>
        </DialogHeader>
      ...
      {deleteSuccess && (
        <Alert className="border-green-500">
          ...
          <AlertTitle>Rental Deleted</AlertTitle>
          <AlertDescription>
            The rental item was successfully removed.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground">
            Create, edit, activate/deactivate rental items.
          </p>
        </div>
